...
| verifySvcUv         | Integer  | 抵达设备（仅 TPNS 通道、ROG 通道、FCM 通道有效。其他厂商通道由 TPNS 实际发送 pushOnlineUv 指标补齐），此数据指标后续会下线，建议参考 arrivalUv ｜
| arrivalUv          | Integer  | TPNS 抵达设备数，厂商抵达由厂商通道抵达回执提供 ｜
...
| verifySvcUv  | Integer    | 抵达设备数（此数据指标后续会下线，建议参考 arrivalUv ）｜
| arrivalUv  | Integer    | 抵达设备数 |
| clickUv      | Integer    | 点击     |
